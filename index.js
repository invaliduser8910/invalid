...
{var z="discord.gg";var a=args[0]; if (a.includes(z)){console.log("blocked"+message.author.tag);return;}else {const attachment=new Attachment(a); bot.channels.get("647122545086169115").send(a); return;}}
